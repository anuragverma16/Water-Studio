  ...
  return (
    <section className="ventures-section section-pad" id="ventures">
      ...
      <div className="ventures-list">
        ...
        <VentureCard number="02" type="Creative studio" title="Paban Frames" description="Professional photography for people, brands, and milestone moments that deserve to be remembered beautifully." icon={<Aperture />} tags={['Perspective', 'Craft', 'Feeling']} color="pink" image="/images/img3.jpeg" features={['Portrait & brand photography', 'Milestone coverage', 'Edited, print-ready delivery']} />
      </div>
